...
with st.sidebar:
    ...
    if store:
        ...
        st.divider()
        st.caption("STORE DETAILS")
        if store.get("address"):
            st.caption("Address: "+store["address"])
        st.caption("Store ID: "+str(store["store_id"]))
...
if store.get("address"):
    st.caption("Address: "+store["address"]+" | Store ID: "+str(store["store_id"]))
    ...
    if a and b and na!=nb:
        ...
        with c1:
            components.html(
                ...
                "<div style='font-size:11px;color:rgba(255,255,255,0.4);margin-top:2px;'>"+a.get("address","")+"</div>"
                "</div>",height=110)
        with c2:
            components.html(
                ...
                "<div style='font-size:11px;color:rgba(255,255,255,0.4);margin-top:2px;'>"+b.get("address","")+"</div>"
                "</div>",height=110)
        st.divider()
        metrics = [
